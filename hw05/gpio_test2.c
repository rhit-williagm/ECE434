...
static unsigned int gpioLED2 = 5;       ///< hard coding the LED gpio for this example to P9_17 (GPIO5)
static unsigned int gpioButton2 = 4;   ///< hard coding the button gpio for this example to P9_18 (GPIO4)
...
// gpio_set_value(gpioLED2, ledOn);          // Not required as set by line above (here for reference)
